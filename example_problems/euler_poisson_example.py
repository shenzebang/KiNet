...
from core.distribution import Uniform, Gaussian, DistributionKinetic
...
class EulerPoisson(ProblemInstance):
    def __init__(self, args, rng):
        ...
        effective_domain_dim = args.domain_dim # (d for position and velocity)
